...
This file is an index; [`docs/release-notes/`](docs/release-notes/) is the
...
- [0.2.3](docs/release-notes/0.2.3.md) — A packaging fix and nothing else
- [0.2.2](docs/release-notes/0.2.2.md) — A bug-fix and legibility release
- [0.2.1](docs/release-notes/0.2.1.md) — The first release published to this repository
