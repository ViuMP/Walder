...
byte-identical to the previous build. The prompts Codex used for the four are still to be appended
under §1 and §2 by Codex; until then this paragraph is their provenance.
