...
function bothOk(): UsageSnapshot {
  return {
    ...
    services: {
      ...
      // Not logged in: the Accounts submenu still gets a Cursor, a Copilot and
      // a Gemini status line, which is the point of having them here, and the
      // card draws no section for any of them.
